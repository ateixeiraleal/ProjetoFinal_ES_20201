		...
		echo "<html>
		    ...
		    <body>
			    <div class='fundoTela'>
					...
					<form action='..\Controller\ExcluirAdocao.php' method='POST' name='f1' autocomplete='off'>
							...
							<tr>
								<td>";
									...
									if($r1->num_rows > 0){
										...
										echo "
											...
											<input type='text' name='cPet' value='".$registroPet['codigoPet']."' hidden>
								...
								<td>";
									...
									if($r3->num_rows > 0){
										...
										echo "
											<input type='text' name='cAdotante' value='".$registroPF['idUsuario']."' hidden>
